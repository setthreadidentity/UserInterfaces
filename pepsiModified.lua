...
CreateWindow: Function (
    Options (table | nil) [
        Name (string | nil) = "Window Name"
        DefaultTheme/Theme (JSON | nil) = "[...]"
        Themeable/DefaultTheme/Theme (boolean | nil) = true or false
        Options [
            Image (string | number | nil) = "" | 18239728064
            Credit (boolean | nil) = true or false
                // Comment: "You're removing my credits? Kinda hurts."
            Info (string | table | nil) = "Extra info displayed in designer" 
                | Lines ["line 1", "line 2", "line 3", "and so on..."]
            Background/Backdrop/Graphic (string | number | table | nil) = "rbxassetid://13337" | 13337
                Options [
                    Asset (string | number | nil) = "rbxassetid://13337" | 13337
                    Transparency (number | nil) = 0.5 | 50
                        // Both examples will make the backdrop half visible
                    Visible (boolean | number | nil) = true or false | 1 or 0
                        // 1: true, 0: false
                ]
        ]
    ]
...
CreateTab: Function (
    Options (table | nil) [
        Name (string | nil) = "Tab Name"
        Image (string | number | nil) = "rbxassetid://133337" | 133337
    ]
        ...
        CreateDesigner: Function (
            (table) Options [
                ...
                (string | number | nil) Image = "rbxassetid://7059346386" | 7059346386
            ...
            SetBackground: Function (
            	(string | boolean | number | nil) AssetString = "rbxassetid://7059346386" | true or false (as Visible arg) | 7059346386 or transparency (0-100 or 0-1) | nil (Toggle visibility)
			...
			if (typ == "number") and (image > 0) then
				pcall(function()
					...
					elseif nfo.AssetTypeId == 13 then
						local decal = game:GetObjects("rbxassetid://17290868707")[1]
	...
	function windowFunctions:CreateDesigner(options, ...)
       ...
       if options.Credit ~= false then
			daaata[1 + #daaata] = {"AddLabel", "__Designer.Label.Creator", detailssection, {
				Text = "Library Modified By: Adulting."
			}}
		elseif "Adulting." then
		end
